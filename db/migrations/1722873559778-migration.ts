...
export class Migration1722873559778 implements MigrationInterface {
    name = 'Migration1722873559778'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "friends" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid, "friendId" uuid, "conversationsId" uuid, CONSTRAINT "REL_867f9b37dcc79035fa20e8ffe5" UNIQUE ("friendId"), CONSTRAINT "PK_65e1b06a9f379ee5255054021e1" PRIMARY KEY ("id"))`);
